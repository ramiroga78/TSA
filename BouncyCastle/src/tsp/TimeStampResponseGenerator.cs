...
namespace Org.BouncyCastle.Tsp
{
    ...
    public class TimeStampResponseGenerator
    {
        ...
        public TimeStampResponse Generate(
            ...
            //string signerUrl)
        {
            return Generate(request, serialNumber, new DateTimeObject(genTime), certThumbprint);
        }
            ...
            //string signerUrl)
        {
            ...
            try
            {
                ...
                try
                {
                    TimeStampToken token = tokenGenerator.Generate(request, serialNumber, genTime.Value, certThumbprint);//, signerUrl);
            ...
            X509Extensions additionalExtensions)
        {
            ...
            try
            {
                ...
                try
                {
                    TimeStampToken token = tokenGenerator.Generate(request, serialNumber, genTime.Value, additionalExtensions, null);//,null);
                    byte[] encoded = token.ToCmsSignedData().GetEncoded();
