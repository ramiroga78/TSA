...
namespace Org.BouncyCastle.Crypto.Operators
{
        ...
        : ISignatureFactory
	{
        ...
        {
            //rewrited, now sending false in forsigning parameter
            ISigner signer = SignerUtilities.InitSigner(algorithm, false, privateKey, random);
