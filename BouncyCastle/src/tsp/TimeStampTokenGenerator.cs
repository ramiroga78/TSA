...
namespace Org.BouncyCastle.Tsp
{
    ...
    public class TimeStampTokenGenerator
    {
          ...
          Asn1.Cms.AttributeTable unsignedAttr)
        {
            ...
            //NOT USING KEY ANY MORE
            Asn1SignatureFactory sigfact = new Asn1SignatureFactory(signatureName, null);
        ...
        {
            return Generate(request, serialNumber, genTime, null, certThumbprint);
        }
            ...
            TimeStampRequest request,
            BigInteger serialNumber,
            DateTime genTime, X509Extensions additionalExtensions, string certThumbprint)//, string signerUrl)
        {
